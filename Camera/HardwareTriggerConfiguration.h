...
//    */
//    class CHardwareTriggerConfiguration : public CConfigurationEventHandler//!!! using hardware trigger must connet line1 and input GND!!!!!!!!!
//    {
//    public:
...
//                            CEnumerationPtr(nodemap.GetNode("TriggerSource"))->FromString("Line1");//Hardware must connet line1 and input GND!!
//
//                            ////The trigger activation must be set to e.g. 'RisingEdge'.
//                            CEnumerationPtr(nodemap.GetNode("TriggerActivation"))->FromString("RisingEdge");//Hardware must connet line1 and input GND!!
//                        }
//                        else
//                        {
